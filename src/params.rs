...
pub struct Parameters {
    pub bfv: bfv::Parameters,
    pub pcs: celpc::Parameters,
    pub embedding_n: usize,
}

impl Parameters {
    pub fn new(bfv: &bfv::Parameters, pcs: &celpc::Parameters) -> Self {
        Parameters {
            bfv: bfv.clone(),
            pcs: pcs.clone(),
            embedding_n: bfv.n << 3,
    ...
    pub fn log_n_14_pk() -> Parameters {
        ...
        let bfv_params = bfv::Parameters::new(1 << 14, &celpc_params.p, 2, 1, 1);
    ...
    pub fn log_n_15_pk() -> Parameters {
        ...
        let bfv_params = bfv::Parameters::new(1 << 15, &celpc_params.p, 4, 1, 1);
